...
<div style="max-width:720px;margin:0 auto;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#16211C;line-height:1.6;">
  ...
  <p style="font-size:14px;">Un chrono récent (marathon, semi, 10 km, ou une course de trail) est projeté sur cette distance-effort grâce à la formule de Riegel, qui modélise la perte de vitesse liée à l'endurance sur un effort plus long. Son auteur n'a validé l'exposant standard (1,06) que jusqu'au marathon — au-delà, la perte de rythme n'est plus linéaire de la même façon. L'exposant utilisé varie donc selon la catégorie officielle de la course (classification ITRA/FFA par km-effort) : 1,06 jusqu'à 115 km-effort, 1,11 pour les formats ultra-trail (catégorie FFA "XL", 115 à 210 km-effort), et 1,17 au-delà de 210 km-effort (catégorie FFA "XXL", 100 miles et plus — UTMB, Diagonale des Fous...).</p>
